...
//Creating the structure of Patients by declaring attributes
    ...
    function SignupPatient(string memory _firstName,string memory _lastName, uint _NIC, string memory _Career, string memory _Address,  string memory _currentMedication) public   {
        ...
        PatientList[_P_ID] = Patient({firstName:_firstName,lastName:_lastName, NIC:_NIC, Career:_Career, Address:_Address,CurrentMedication:_currentMedication,accountNum: msg.sender});
    ...
    function adding_Record(string memory _FID,string memory _fileName,string memory _fileType, uint _date, bytes10 _PatientID) external{
        Patient memory patient = PatientList[_PatientID];
    ...
    function retrieve_Records(uint _indexNum,bytes10 _PatientID) external view returns(string memory, string memory, string memory, uint){
         Patient memory patient = PatientList[_PatientID];
    ...
    function getLength(bytes10 _PatientID) external view returns(uint){
        Patient memory patient = PatientList[_PatientID];
