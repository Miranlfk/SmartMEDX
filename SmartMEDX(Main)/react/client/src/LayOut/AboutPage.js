...
function AboutPage() {
  return (
     ...
     <div className='cover-about'>
                <h3 className='para-head'>About Us</h3>
            
             <div className='aboutus'>
                  <p className='para'>SmartMEDX revolutionizing your healthcare! SmartMEDX is a platform built with the vision of changing the healthcare industry's landscape 
